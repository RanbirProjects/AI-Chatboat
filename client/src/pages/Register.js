...
import { Eye, EyeOff, Brain, Zap, Shield, UserPlus } from 'lucide-react';
        ...
        <div className="relative z-10 flex flex-col justify-center items-center h-full text-white text-center px-12">
          <div className="mb-8">
            ...
            <p className="text-xl text-blue-100 leading-relaxed">
              Create your account and start exploring intelligent conversations
            </p>
          </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
              <div className="text-center">
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  Demo Mode: Use any valid credentials to register
                </p>
              </div>
            </div>
          </div>
